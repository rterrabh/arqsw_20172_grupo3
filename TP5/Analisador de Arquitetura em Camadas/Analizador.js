...
restricoes.push(new Dependencia("Models", "Controller"));
restricoes.push(new Dependencia("Models", "View"));
restricoes.push(new Dependencia("View", "Models"));
restricoes.push(new Dependencia("Controllers", "Terra"));
...
const paths = [];
paths.push(new Path("Controllers", "C:\\Users\\MONTILA\\Documents\\GitHub\\arqsw_20172_grupo3\\TP5\\SistemaExemplo\\controllers"));
paths.push(new Path("Models", "C:\\Users\\MONTILA\\Documents\\GitHub\\arqsw_20172_grupo3\\TP5\\SistemaExemplo\\model"));;
paths.push(new Path("View", "C:\\Users\\MONTILA\\Documents\\GitHub\\arqsw_20172_grupo3\\TP5\\SistemaExemplo\\view"));;
